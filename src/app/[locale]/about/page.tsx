  ...
  return (
    <div className="container-page max-w-4xl py-10 md:py-16">
      ...
      <section className="mt-12">
        ...
        <ol className="mt-5 grid grid-cols-1 panel notch-br gap-px overflow-hidden bg-line md:grid-cols-3">
      ...
      <section className="mt-12 flex flex-wrap items-center justify-between gap-5 panel notch-br bg-surface p-6">
